    ...
    <div>
      ...
      >
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
          ...
          <Link to="/events" className="btn-outline bg-white/10 border-white text-white hover:bg-white hover:text-deep-navy text-lg px-8 py-4">
            See Upcoming Events
          </Link>
        </div>
      </Hero>
      ...
      <section className="py-16 bg-deep-navy text-white">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/volunteer" className="btn-outline border-white text-white hover:bg-white hover:text-deep-navy text-lg px-8 py-4">
              Volunteer With Us
            </Link>
          </div>
        </div>
